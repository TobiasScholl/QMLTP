...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV086+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV086+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0027 , conjecture , ( $box @ ( ( $box @ ( ~ ( ( $box @ ( ( geq @ pv65 @ tptp_float_0_001 ) ) ) ) ) ) => ( $box @ ( true ) ) ) ) ) .
