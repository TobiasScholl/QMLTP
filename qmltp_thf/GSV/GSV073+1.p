...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV073+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV073+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0014 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv31 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv35 ) ) ) & ( ( $box @ ( ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) ) & ( $box @ ( ( leq @ pv35 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv31 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv35 ) ) ) & ( ( $box @ ( ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) ) & ( $box @ ( ( leq @ pv35 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) ) ) ) .
