...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV091+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV091+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( quaternion_ds1_inuse_0003 , conjecture , ( $box @ ( ( ( $box @ ( ( a_select2 @ rho_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n0 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n1 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n2 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n4 ) = use ) ) & ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n5 ) = use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) => ( ( $box @ ( ( a_select2 @ rho_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n0 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n1 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n2 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_noise_defuse @ n0 @ use ) @ n1 @ use ) @ n2 @ use ) @ n3 @ use ) @ n4 @ use ) @ n5 @ use ) @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_noise_defuse @ n0 @ use ) @ n1 @ use ) @ n2 @ use ) @ n3 @ use ) @ n4 @ use ) @ n5 @ use ) @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_noise_defuse @ n0 @ use ) @ n1 @ use ) @ n2 @ use ) @ n3 @ use ) @ n4 @ use ) @ n5 @ use ) @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_noise_defuse @ n0 @ use ) @ n1 @ use ) @ n2 @ use ) @ n3 @ use ) @ n4 @ use ) @ n5 @ use ) @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_noise_defuse @ n0 @ use ) @ n1 @ use ) @ n2 @ use ) @ n3 @ use ) @ n4 @ use ) @ n5 @ use ) @ n4 ) = use ) ) & ( $box @ ( ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_noise_defuse @ n0 @ use ) @ n1 @ use ) @ n2 @ use ) @ n3 @ use ) @ n4 @ use ) @ n5 @ use ) @ n5 ) = use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
