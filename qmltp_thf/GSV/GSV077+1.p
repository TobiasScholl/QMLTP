...
thf ( cl5_nebula_array_0018 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv31 ) ) ) & ( $box @ ( ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv31 ) ) ) & ( ( $box @ ( ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) ) & ( ( $box @ ( ( $box @ ( ~ ( ( $box @ ( n0 = pv40 ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv31 ) ) ) & ( $box @ ( ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) & ( $box @ ( ( $box @ ( n0 = pv40 ) ) => ( $box @ ( true ) ) ) ) ) ) ) ) ) ) .
