...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV105+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV105+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( quaternion_ds1_inuse_0017 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv43 ) ) ) & ( $box @ ( ( leq @ pv43 @ ( minus @ n6 @ n1 ) ) ) ) ) => ( $box @ ( ( $box @ ( ( lt @ n0 @ ( a_select2 @ sigma @ pv43 ) ) ) ) => ( $box @ ( true ) ) ) ) ) ) ) .
