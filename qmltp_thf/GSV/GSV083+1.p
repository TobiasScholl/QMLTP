...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV083+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV083+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0024 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv66 ) ) ) & ( $box @ ( ( leq @ pv66 @ ( minus @ n5 @ n1 ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv66 ) ) ) & ( $box @ ( ( leq @ pv66 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) .
