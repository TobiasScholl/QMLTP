...
thf(tptp_float_0_001_type,type,(tptp_float_0_001 : ($i))).
thf(tptp_float_0_0_type,type,(tptp_float_0_0 : ($i))).
thf(loopcounter_type,type,(loopcounter : ($i))).
thf(pv65_type,type,(pv65 : ($i))).
...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV087+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV087+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0028 , conjecture , ( $box @ ( ( $box @ ( ( geq @ pv65 @ tptp_float_0_001 ) ) ) => ( ( $box @ ( ( $box @ ( ~ ( ( $box @ ( ( gt @ ( plus @ n1 @ loopcounter ) @ n1 ) ) ) ) ) ) => ( $box @ ( true ) ) ) ) & ( $box @ ( ( $box @ ( ( gt @ ( plus @ n1 @ loopcounter ) @ n1 ) ) ) => ( $box @ ( true ) ) ) ) ) ) ) ) .
