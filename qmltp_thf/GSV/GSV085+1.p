...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV085+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV085+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0026 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv68 ) ) ) & ( $box @ ( ( leq @ pv68 @ ( minus @ n5 @ n1 ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv68 ) ) ) & ( $box @ ( ( leq @ pv68 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) .
