...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV088+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV088+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0029 , conjecture , ( $box @ ( ( $box @ ( ( geq @ ( minus @ n135300 @ n1 ) @ n0 ) ) ) => ( $box @ ( true ) ) ) ) ) .
