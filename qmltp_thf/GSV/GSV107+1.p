...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV107+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV107+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( quaternion_ds1_inuse_0019 , conjecture , ( $box @ ( ( $box @ ( ( geq @ ( minus @ n3 @ n1 ) @ n0 ) ) ) => ( $box @ ( ( $box @ ( ( geq @ ( minus @ n6 @ n1 ) @ n0 ) ) ) => ( $box @ ( ( ( $box @ ( ( geq @ n2 @ n0 ) ) ) & ( $box @ ( ( geq @ ( minus @ n999 @ n1 ) @ n0 ) ) ) ) => ( $box @ ( ( $box @ ( ( geq @ ( minus @ n6 @ n1 ) @ n0 ) ) ) => ( $box @ ( ( $box @ ( ( geq @ ( minus @ n6 @ n1 ) @ n0 ) ) ) => ( $box @ ( ( $box @ ( ( geq @ ( minus @ n6 @ n1 ) @ n0 ) ) ) => ( $box @ ( ( ( $box @ ( ( geq @ ( minus @ n3 @ n1 ) @ n0 ) ) ) & ( $box @ ( ( geq @ ( minus @ n999 @ n1 ) @ n0 ) ) ) ) => ( $box @ ( true ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
