...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV081+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV081+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0022 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv57 ) ) ) & ( $box @ ( ( leq @ pv57 @ ( minus @ n5 @ n1 ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv57 ) ) ) & ( $box @ ( ( leq @ pv57 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) .
