...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV089+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV089+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( quaternion_ds1_inuse_0001 , conjecture , ( $box @ ( ( $box @ ( true ) ) => ( ( $box @ ( ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n2 @ n0 @ use ) @ n1 @ n0 @ use ) @ n2 @ n0 @ use ) @ n0 @ n0 @ use ) @ n1 @ n0 @ use ) @ n0 @ n0 @ use ) @ n0 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n2 @ n0 @ use ) @ n1 @ n0 @ use ) @ n2 @ n0 @ use ) @ n0 @ n0 @ use ) @ n1 @ n0 @ use ) @ n0 @ n0 @ use ) @ n1 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ ( tptp_update3 @ u_defuse @ n2 @ n0 @ use ) @ n1 @ n0 @ use ) @ n2 @ n0 @ use ) @ n0 @ n0 @ use ) @ n1 @ n0 @ use ) @ n0 @ n0 @ use ) @ n2 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_defuse @ n5 @ use ) @ n4 @ use ) @ n5 @ use ) @ n3 @ use ) @ n4 @ use ) @ n3 @ use ) @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_defuse @ n5 @ use ) @ n4 @ use ) @ n5 @ use ) @ n3 @ use ) @ n4 @ use ) @ n3 @ use ) @ n4 ) = use ) ) & ( $box @ ( ( a_select2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ ( tptp_update2 @ xinit_defuse @ n5 @ use ) @ n4 @ use ) @ n5 @ use ) @ n3 @ use ) @ n4 @ use ) @ n3 @ use ) @ n5 ) = use ) ) ) ) ) ) ) ) ) ) .
