...
thf(pv51_type,type,(pv51 : ($i))).
thf(pv52_type,type,(pv52 : ($i))).
...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV094+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV094+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
%--------------------------------------------------------------------------
thf ( reflexivity , axiom , ( $box @ ( ! [ X :$i ] : ( $box @ ( X = X ) ) ) ) ) .
thf ( symmetry , axiom , ( $box @ ( ! [ X :$i ] : ( $box @ ( ! [ Y :$i ] : ( $box @ ( ( $box @ ( X = Y ) ) => ( $box @ ( Y = X ) ) ) ) ) ) ) ) ) .
thf ( transitivity , axiom , ( $box @ ( ! [ X :$i ] : ( $box @ ( ! [ Y :$i ] : ( $box @ ( ! [ Z :$i ] : ( $box @ ( ( ( $box @ ( X = Y ) ) & ( $box @ ( Y = Z ) ) ) => ( $box @ ( X = Z ) ) ) ) ) ) ) ) ) ) ) .
thf ( a_select2_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( a_select2 @ A @ C ) = ( a_select2 @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( a_select2_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( a_select2 @ C @ A ) = ( a_select2 @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( a_select3_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( a_select3 @ A @ C @ D ) = ( a_select3 @ B @ C @ D ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( a_select3_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( a_select3 @ C @ A @ D ) = ( a_select3 @ C @ B @ D ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( a_select3_substitution_3 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( a_select3 @ C @ D @ A ) = ( a_select3 @ C @ D @ B ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( dim_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( dim @ A @ C ) = ( dim @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( dim_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( dim @ C @ A ) = ( dim @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( inv_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( inv @ A ) = ( inv @ B ) ) ) ) ) ) ) ) ) ) .
thf ( minus_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( minus @ A @ C ) = ( minus @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( minus_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( minus @ C @ A ) = ( minus @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( plus_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( plus @ A @ C ) = ( plus @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( plus_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( plus @ C @ A ) = ( plus @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( pred_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( pred @ A ) = ( pred @ B ) ) ) ) ) ) ) ) ) ) .
thf ( succ_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( succ @ A ) = ( succ @ B ) ) ) ) ) ) ) ) ) ) .
thf ( sum_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( sum @ A @ C @ D ) = ( sum @ B @ C @ D ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( sum_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( sum @ C @ A @ D ) = ( sum @ C @ B @ D ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( sum_substitution_3 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( sum @ C @ D @ A ) = ( sum @ C @ D @ B ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_const_array1_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_const_array1 @ A @ C ) = ( tptp_const_array1 @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_const_array1_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_const_array1 @ C @ A ) = ( tptp_const_array1 @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_const_array2_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_const_array2 @ A @ C @ D ) = ( tptp_const_array2 @ B @ C @ D ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_const_array2_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_const_array2 @ C @ A @ D ) = ( tptp_const_array2 @ C @ B @ D ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_const_array2_substitution_3 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_const_array2 @ C @ D @ A ) = ( tptp_const_array2 @ C @ D @ B ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_madd_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_madd @ A @ C ) = ( tptp_madd @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_madd_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_madd @ C @ A ) = ( tptp_madd @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_mmul_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_mmul @ A @ C ) = ( tptp_mmul @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_mmul_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_mmul @ C @ A ) = ( tptp_mmul @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_msub_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_msub @ A @ C ) = ( tptp_msub @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_msub_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_msub @ C @ A ) = ( tptp_msub @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_update2_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_update2 @ A @ C @ D ) = ( tptp_update2 @ B @ C @ D ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_update2_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_update2 @ C @ A @ D ) = ( tptp_update2 @ C @ B @ D ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_update2_substitution_3 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_update2 @ C @ D @ A ) = ( tptp_update2 @ C @ D @ B ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_update3_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ! [ E :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_update3 @ A @ C @ D @ E ) = ( tptp_update3 @ B @ C @ D @ E ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_update3_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ! [ E :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_update3 @ C @ A @ D @ E ) = ( tptp_update3 @ C @ B @ D @ E ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_update3_substitution_3 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ! [ E :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_update3 @ C @ D @ A @ E ) = ( tptp_update3 @ C @ D @ B @ E ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( tptp_update3_substitution_4 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ! [ E :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( tptp_update3 @ C @ D @ E @ A ) = ( tptp_update3 @ C @ D @ E @ B ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( trans_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( trans @ A ) = ( trans @ B ) ) ) ) ) ) ) ) ) ) .
thf ( uniform_int_rnd_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( uniform_int_rnd @ A @ C ) = ( uniform_int_rnd @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( uniform_int_rnd_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( $box @ ( A = B ) ) => ( $box @ ( ( uniform_int_rnd @ C @ A ) = ( uniform_int_rnd @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( geq_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( ( $box @ ( A = B ) ) & ( $box @ ( ( geq @ A @ C ) ) ) ) => ( $box @ ( ( geq @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( geq_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( ( $box @ ( A = B ) ) & ( $box @ ( ( geq @ C @ A ) ) ) ) => ( $box @ ( ( geq @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( gt_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( ( $box @ ( A = B ) ) & ( $box @ ( ( gt @ A @ C ) ) ) ) => ( $box @ ( ( gt @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( gt_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( ( $box @ ( A = B ) ) & ( $box @ ( ( gt @ C @ A ) ) ) ) => ( $box @ ( ( gt @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( leq_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( ( $box @ ( A = B ) ) & ( $box @ ( ( leq @ A @ C ) ) ) ) => ( $box @ ( ( leq @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( leq_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( ( $box @ ( A = B ) ) & ( $box @ ( ( leq @ C @ A ) ) ) ) => ( $box @ ( ( leq @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( lt_substitution_1 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( ( $box @ ( A = B ) ) & ( $box @ ( ( lt @ A @ C ) ) ) ) => ( $box @ ( ( lt @ B @ C ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( lt_substitution_2 , axiom , ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ! [ C :$i ] : ( $box @ ( ( ( $box @ ( A = B ) ) & ( $box @ ( ( lt @ C @ A ) ) ) ) => ( $box @ ( ( lt @ C @ B ) ) ) ) ) ) ) ) ) ) ) ) .
...
thf ( quaternion_ds1_inuse_0006 , conjecture , ( $box @ ( ( ( $box @ ( ( a_select2 @ rho_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n0 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n1 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n2 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( leq @ n0 @ pv5 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv51 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv52 ) ) ) & ( ( $box @ ( ( leq @ pv5 @ ( minus @ n999 @ n1 ) ) ) ) & ( ( $box @ ( ( leq @ pv51 @ ( minus @ n6 @ n1 ) ) ) ) & ( ( $box @ ( ( leq @ pv52 @ ( minus @ n6 @ n1 ) ) ) ) & ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ A ) ) ) & ( ( $box @ ( ( leq @ n0 @ B ) ) ) & ( ( $box @ ( ( leq @ A @ n2 ) ) ) & ( $box @ ( ( leq @ B @ ( minus @ pv5 @ n1 ) ) ) ) ) ) ) => ( ( $box @ ( ( a_select3 @ u_defuse @ A @ B ) = use ) ) & ( $box @ ( ( a_select3 @ z_defuse @ A @ B ) = use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) => ( ( $box @ ( ( $box @ ( ~ ( ( $box @ ( pv51 = pv52 ) ) ) ) ) => ( ( $box @ ( ( a_select2 @ rho_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n0 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n1 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n2 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( leq @ n0 @ pv5 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv51 ) ) ) & ( ( $box @ ( ( leq @ pv5 @ ( minus @ n999 @ n1 ) ) ) ) & ( ( $box @ ( ( leq @ pv51 @ ( minus @ n6 @ n1 ) ) ) ) & ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ C ) ) ) & ( ( $box @ ( ( leq @ n0 @ D ) ) ) & ( ( $box @ ( ( leq @ C @ n2 ) ) ) & ( $box @ ( ( leq @ D @ ( minus @ pv5 @ n1 ) ) ) ) ) ) ) => ( ( $box @ ( ( a_select3 @ u_defuse @ C @ D ) = use ) ) & ( $box @ ( ( a_select3 @ z_defuse @ C @ D ) = use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) & ( $box @ ( ( $box @ ( pv51 = pv52 ) ) => ( ( $box @ ( ( a_select2 @ rho_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n0 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n1 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n2 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( leq @ n0 @ pv5 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv51 ) ) ) & ( ( $box @ ( ( leq @ pv5 @ ( minus @ n999 @ n1 ) ) ) ) & ( ( $box @ ( ( leq @ pv51 @ ( minus @ n6 @ n1 ) ) ) ) & ( $box @ ( ! [ E :$i ] : ( $box @ ( ! [ F :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ E ) ) ) & ( ( $box @ ( ( leq @ n0 @ F ) ) ) & ( ( $box @ ( ( leq @ E @ n2 ) ) ) & ( $box @ ( ( leq @ F @ ( minus @ pv5 @ n1 ) ) ) ) ) ) ) => ( ( $box @ ( ( a_select3 @ u_defuse @ E @ F ) = use ) ) & ( $box @ ( ( a_select3 @ z_defuse @ E @ F ) = use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( gt_5_4 , axiom , ( $box @ ( ( gt @ n5 @ n4 ) ) ) ) .
thf ( gt_6_4 , axiom , ( $box @ ( ( gt @ n6 @ n4 ) ) ) ) .
thf ( gt_999_4 , axiom , ( $box @ ( ( gt @ n999 @ n4 ) ) ) ) .
thf ( gt_6_5 , axiom , ( $box @ ( ( gt @ n6 @ n5 ) ) ) ) .
thf ( gt_999_5 , axiom , ( $box @ ( ( gt @ n999 @ n5 ) ) ) ) .
thf ( gt_999_6 , axiom , ( $box @ ( ( gt @ n999 @ n6 ) ) ) ) .
thf ( gt_4_tptp_minus_1 , axiom , ( $box @ ( ( gt @ n4 @ tptp_minus_1 ) ) ) ) .
thf ( gt_5_tptp_minus_1 , axiom , ( $box @ ( ( gt @ n5 @ tptp_minus_1 ) ) ) ) .
thf ( gt_6_tptp_minus_1 , axiom , ( $box @ ( ( gt @ n6 @ tptp_minus_1 ) ) ) ) .
...
thf ( finite_domain_6 , axiom , ( $box @ ( ! [ X :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ X ) ) ) & ( $box @ ( ( leq @ X @ n6 ) ) ) ) => ( ( $box @ ( X = n0 ) ) | ( ( $box @ ( X = n1 ) ) | ( ( $box @ ( X = n2 ) ) | ( ( $box @ ( X = n3 ) ) | ( ( $box @ ( X = n4 ) ) | ( ( $box @ ( X = n5 ) ) | ( $box @ ( X = n6 ) ) ) ) ) ) ) ) ) ) ) ) ) .
...
thf ( successor_6 , axiom , ( $box @ ( ( succ @ ( succ @ ( succ @ ( succ @ ( succ @ ( succ @ n0 ) ) ) ) ) ) = n6 ) ) ) .
