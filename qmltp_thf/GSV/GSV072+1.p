...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV072+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV072+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0013 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv21 ) ) ) & ( $box @ ( ( leq @ pv21 @ ( minus @ n5 @ n1 ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv21 ) ) ) & ( $box @ ( ( leq @ pv21 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) .
