...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV084+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV084+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0025 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv67 ) ) ) & ( $box @ ( ( leq @ pv67 @ ( minus @ n5 @ n1 ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv67 ) ) ) & ( $box @ ( ( leq @ pv67 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) .
