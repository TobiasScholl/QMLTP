...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV093+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV093+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( quaternion_ds1_inuse_0005 , conjecture , ( $box @ ( ( ( $box @ ( ( a_select2 @ rho_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n0 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n1 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n2 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( leq @ n0 @ pv5 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv41 ) ) ) & ( ( $box @ ( ( leq @ pv5 @ ( minus @ n999 @ n1 ) ) ) ) & ( ( $box @ ( ( leq @ pv41 @ ( minus @ n6 @ n1 ) ) ) ) & ( ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ A ) ) ) & ( ( $box @ ( ( leq @ n0 @ B ) ) ) & ( ( $box @ ( ( leq @ A @ n2 ) ) ) & ( $box @ ( ( leq @ B @ pv5 ) ) ) ) ) ) => ( ( $box @ ( ( a_select3 @ u_defuse @ A @ B ) = use ) ) & ( $box @ ( ( a_select3 @ z_defuse @ A @ B ) = use ) ) ) ) ) ) ) ) ) & ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ C ) ) ) & ( ( $box @ ( ( leq @ n0 @ D ) ) ) & ( ( $box @ ( ( leq @ C @ n2 ) ) ) & ( $box @ ( ( leq @ D @ ( minus @ pv5 @ n1 ) ) ) ) ) ) ) => ( ( $box @ ( ( a_select3 @ u_defuse @ C @ D ) = use ) ) & ( $box @ ( ( a_select3 @ z_defuse @ C @ D ) = use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) => ( ( $box @ ( ( a_select2 @ rho_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n0 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n1 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n2 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( leq @ n0 @ pv5 ) ) ) & ( ( $box @ ( ( leq @ pv5 @ ( minus @ n999 @ n1 ) ) ) ) & ( ( $box @ ( ! [ E :$i ] : ( $box @ ( ! [ F :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ E ) ) ) & ( ( $box @ ( ( leq @ n0 @ F ) ) ) & ( ( $box @ ( ( leq @ E @ n2 ) ) ) & ( $box @ ( ( leq @ F @ pv5 ) ) ) ) ) ) => ( ( $box @ ( ( a_select3 @ u_defuse @ E @ F ) = use ) ) & ( $box @ ( ( a_select3 @ z_defuse @ E @ F ) = use ) ) ) ) ) ) ) ) ) & ( $box @ ( ! [ G :$i ] : ( $box @ ( ! [ H :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ G ) ) ) & ( ( $box @ ( ( leq @ n0 @ H ) ) ) & ( ( $box @ ( ( leq @ G @ n2 ) ) ) & ( $box @ ( ( leq @ H @ ( minus @ pv5 @ n1 ) ) ) ) ) ) ) => ( ( $box @ ( ( a_select3 @ u_defuse @ G @ H ) = use ) ) & ( $box @ ( ( a_select3 @ z_defuse @ G @ H ) = use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
