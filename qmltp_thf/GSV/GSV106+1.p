...
thf(n_statevars_type,type,(n_statevars : ($i))).
thf(m_measvars_type,type,(m_measvars : ($i))).
...
thf(n_steps_type,type,(n_steps : ($i))).
...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV106+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV106+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( quaternion_ds1_inuse_0018 , conjecture , ( $box @ ( ( ( $box @ ( ! [ A :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ A ) ) ) & ( $box @ ( ( leq @ A @ ( minus @ m_measvars @ n1 ) ) ) ) ) => ( $box @ ( ( a_select2 @ rho_defuse @ A ) = use ) ) ) ) ) ) & ( ( $box @ ( ! [ B :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ B ) ) ) & ( $box @ ( ( leq @ B @ ( minus @ n_statevars @ n1 ) ) ) ) ) => ( $box @ ( ( a_select2 @ sigma_defuse @ B ) = use ) ) ) ) ) ) & ( ( $box @ ( ! [ C :$i ] : ( $box @ ( ! [ D :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ C ) ) ) & ( ( $box @ ( ( leq @ n0 @ D ) ) ) & ( ( $box @ ( ( leq @ C @ n2 ) ) ) & ( $box @ ( ( leq @ D @ ( minus @ n_steps @ n1 ) ) ) ) ) ) ) => ( $box @ ( ( a_select3 @ u_defuse @ C @ D ) = use ) ) ) ) ) ) ) ) & ( ( $box @ ( ! [ E :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ E ) ) ) & ( $box @ ( ( leq @ E @ ( minus @ n_statevars @ n1 ) ) ) ) ) => ( $box @ ( ( a_select2 @ xinit_defuse @ E ) = use ) ) ) ) ) ) & ( ( $box @ ( ! [ F :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ F ) ) ) & ( $box @ ( ( leq @ F @ ( minus @ n_statevars @ n1 ) ) ) ) ) => ( $box @ ( ( a_select2 @ xinit_mean_defuse @ F ) = use ) ) ) ) ) ) & ( ( $box @ ( ! [ G :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ G ) ) ) & ( $box @ ( ( leq @ G @ ( minus @ n_statevars @ n1 ) ) ) ) ) => ( $box @ ( ( a_select2 @ xinit_noise_defuse @ G ) = use ) ) ) ) ) ) & ( $box @ ( ! [ H :$i ] : ( $box @ ( ! [ I :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ H ) ) ) & ( ( $box @ ( ( leq @ n0 @ I ) ) ) & ( ( $box @ ( ( leq @ H @ ( minus @ m_measvars @ n1 ) ) ) ) & ( $box @ ( ( leq @ I @ ( minus @ n_steps @ n1 ) ) ) ) ) ) ) => ( $box @ ( ( a_select3 @ z_defuse @ H @ I ) = use ) ) ) ) ) ) ) ) ) ) ) ) ) ) => ( $box @ ( true ) ) ) ) ) .
