...
thf(q_type,type,(q : ($i))).
thf(pv10_type,type,(pv10 : ($i))).
thf(tptp_minus_1_type,type,(tptp_minus_1 : ($i))).
thf(pv78_type,type,(pv78 : ($i))).
thf(n135300_type,type,(n135300 : ($i))).
thf(pv63_type,type,(pv63 : ($i))).
...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV067+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV067+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0008 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv10 ) ) ) & ( ( $box @ ( ( leq @ n1 @ pv63 ) ) ) & ( ( $box @ ( ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) ) & ( $box @ ( ( leq @ pv63 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv10 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv63 ) ) ) & ( ( $box @ ( ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) ) & ( ( $box @ ( ( leq @ pv63 @ ( minus @ n5 @ n1 ) ) ) ) & ( ( $box @ ( ( $box @ ( ~ ( ( $box @ ( ( gt @ ( a_select3 @ q @ pv10 @ pv63 ) @ pv78 ) ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv10 ) ) ) & ( $box @ ( ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) & ( $box @ ( ( $box @ ( ( gt @ ( a_select3 @ q @ pv10 @ pv63 ) @ pv78 ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv10 ) ) ) & ( $box @ ( ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
thf ( gt_5_4 , axiom , ( $box @ ( ( gt @ n5 @ n4 ) ) ) ) .
thf ( gt_135300_4 , axiom , ( $box @ ( ( gt @ n135300 @ n4 ) ) ) ) .
thf ( gt_135300_5 , axiom , ( $box @ ( ( gt @ n135300 @ n5 ) ) ) ) .
thf ( gt_4_tptp_minus_1 , axiom , ( $box @ ( ( gt @ n4 @ tptp_minus_1 ) ) ) ) .
thf ( gt_5_tptp_minus_1 , axiom , ( $box @ ( ( gt @ n5 @ tptp_minus_1 ) ) ) ) .
thf ( gt_135300_tptp_minus_1 , axiom , ( $box @ ( ( gt @ n135300 @ tptp_minus_1 ) ) ) ) .
...
thf ( gt_135300_0 , axiom , ( $box @ ( ( gt @ n135300 @ n0 ) ) ) ) .
