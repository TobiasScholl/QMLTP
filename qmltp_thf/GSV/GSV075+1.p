...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV075+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV075+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0016 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv31 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv37 ) ) ) & ( ( $box @ ( ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) ) & ( $box @ ( ( leq @ pv37 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv31 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv37 ) ) ) & ( ( $box @ ( ( leq @ pv31 @ ( minus @ n5 @ n1 ) ) ) ) & ( $box @ ( ( leq @ pv37 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) ) ) ) .
