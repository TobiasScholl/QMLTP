...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV101+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV101+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( quaternion_ds1_inuse_0013 , conjecture , ( $box @ ( ( ( $box @ ( ( a_select2 @ rho_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ rho_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ sigma_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n0 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n1 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select3 @ u_defuse @ n2 @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_mean_defuse @ n5 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n0 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n1 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n2 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n3 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n4 ) = use ) ) & ( ( $box @ ( ( a_select2 @ xinit_noise_defuse @ n5 ) = use ) ) & ( $box @ ( ! [ A :$i ] : ( $box @ ( ! [ B :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ A ) ) ) & ( ( $box @ ( ( leq @ n0 @ B ) ) ) & ( ( $box @ ( ( leq @ A @ n2 ) ) ) & ( $box @ ( ( leq @ B @ ( minus @ ( plus @ n1 @ ( minus @ n999 @ n1 ) ) @ n1 ) ) ) ) ) ) ) => ( ( $box @ ( ( a_select3 @ u_defuse @ A @ B ) = use ) ) & ( $box @ ( ( a_select3 @ z_defuse @ A @ B ) = use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) => ( ( $box @ ( ! [ C :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ C ) ) ) & ( $box @ ( ( leq @ C @ ( minus @ n3 @ n1 ) ) ) ) ) => ( $box @ ( ( a_select2 @ rho_defuse @ C ) = use ) ) ) ) ) ) & ( ( $box @ ( ! [ D :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ D ) ) ) & ( $box @ ( ( leq @ D @ ( minus @ n6 @ n1 ) ) ) ) ) => ( $box @ ( ( a_select2 @ sigma_defuse @ D ) = use ) ) ) ) ) ) & ( ( $box @ ( ! [ E :$i ] : ( $box @ ( ! [ F :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ E ) ) ) & ( ( $box @ ( ( leq @ n0 @ F ) ) ) & ( ( $box @ ( ( leq @ E @ n2 ) ) ) & ( $box @ ( ( leq @ F @ ( minus @ n999 @ n1 ) ) ) ) ) ) ) => ( $box @ ( ( a_select3 @ u_defuse @ E @ F ) = use ) ) ) ) ) ) ) ) & ( ( $box @ ( ! [ G :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ G ) ) ) & ( $box @ ( ( leq @ G @ ( minus @ n6 @ n1 ) ) ) ) ) => ( $box @ ( ( a_select2 @ xinit_defuse @ G ) = use ) ) ) ) ) ) & ( ( $box @ ( ! [ H :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ H ) ) ) & ( $box @ ( ( leq @ H @ ( minus @ n6 @ n1 ) ) ) ) ) => ( $box @ ( ( a_select2 @ xinit_mean_defuse @ H ) = use ) ) ) ) ) ) & ( ( $box @ ( ! [ I :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ I ) ) ) & ( $box @ ( ( leq @ I @ ( minus @ n6 @ n1 ) ) ) ) ) => ( $box @ ( ( a_select2 @ xinit_noise_defuse @ I ) = use ) ) ) ) ) ) & ( $box @ ( ! [ J :$i ] : ( $box @ ( ! [ K :$i ] : ( $box @ ( ( ( $box @ ( ( leq @ n0 @ J ) ) ) & ( ( $box @ ( ( leq @ n0 @ K ) ) ) & ( ( $box @ ( ( leq @ J @ ( minus @ n3 @ n1 ) ) ) ) & ( $box @ ( ( leq @ K @ ( minus @ n999 @ n1 ) ) ) ) ) ) ) => ( $box @ ( ( a_select3 @ z_defuse @ J @ K ) = use ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) .
