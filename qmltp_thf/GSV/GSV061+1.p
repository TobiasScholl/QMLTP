...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV061+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV061+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0002 , conjecture , ( $box @ ( ( $box @ ( true ) ) => ( ( $box @ ( ( $box @ ( ~ ( ( $box @ ( ( gt @ loopcounter @ n1 ) ) ) ) ) ) => ( $box @ ( true ) ) ) ) & ( $box @ ( ( $box @ ( ( gt @ loopcounter @ n1 ) ) ) => ( $box @ ( true ) ) ) ) ) ) ) ) .
