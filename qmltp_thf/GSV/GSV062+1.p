...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV062+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV062+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0003 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv10 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv41 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv43 ) ) ) & ( ( $box @ ( ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) ) & ( ( $box @ ( ( leq @ pv41 @ ( minus @ n5 @ n1 ) ) ) ) & ( $box @ ( ( leq @ pv43 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv10 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv41 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv43 ) ) ) & ( ( $box @ ( ( leq @ pv10 @ ( minus @ n135300 @ n1 ) ) ) ) & ( ( $box @ ( ( leq @ pv41 @ ( minus @ n5 @ n1 ) ) ) ) & ( $box @ ( ( leq @ pv43 @ ( minus @ n5 @ n1 ) ) ) ) ) ) ) ) ) ) ) ) .
