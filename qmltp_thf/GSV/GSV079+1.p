...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV079+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV079+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0020 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv51 ) ) ) & ( $box @ ( ( leq @ pv51 @ ( minus @ n5 @ n1 ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ n0 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv51 ) ) ) & ( ( $box @ ( ( leq @ n0 @ ( uniform_int_rnd @ n1 @ ( minus @ ( minus @ n135300 @ n1 ) @ n0 ) ) ) ) ) & ( ( $box @ ( ( leq @ pv51 @ ( minus @ n5 @ n1 ) ) ) ) & ( $box @ ( ( leq @ ( uniform_int_rnd @ n1 @ ( minus @ ( minus @ n135300 @ n1 ) @ n0 ) ) @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) ) ) ) ) .
