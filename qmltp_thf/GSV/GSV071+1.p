...
thf(pv21_type,type,(pv21 : ($i))).
thf(pv23_type,type,(pv23 : ($i))).
...
% converted problem
%--------------------------------------------------------------------------
% File     : GSV071+1 : QMLTP v1.1
% Domain   : GSV (Goedel translation of Software Verification)
% Problem  : Goedel translation of SWV071+1 (from TPTP-v5.0.0)
% Version  : Especial.
% English  :
...
thf ( cl5_nebula_array_0012 , conjecture , ( $box @ ( ( ( $box @ ( ( leq @ n0 @ pv21 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv23 ) ) ) & ( ( $box @ ( ( leq @ pv21 @ ( minus @ n5 @ n1 ) ) ) ) & ( $box @ ( ( leq @ pv23 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) => ( ( $box @ ( ( leq @ n0 @ pv21 ) ) ) & ( ( $box @ ( ( leq @ n0 @ pv23 ) ) ) & ( ( $box @ ( ( leq @ pv21 @ ( minus @ n5 @ n1 ) ) ) ) & ( $box @ ( ( leq @ pv23 @ ( minus @ n135300 @ n1 ) ) ) ) ) ) ) ) ) ) .
