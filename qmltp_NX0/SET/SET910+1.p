...
tff(t51_zfmisc_1, conjecture, (! [A:$i,B:$i]: ((qmltpeq(set_intersection2(A,singleton(B)),singleton(B)) => in(B,A))))).
tff(l30_zfmisc_1, axiom, (! [A:$i,B:$i]: ((qmltpeq(set_intersection2(A,singleton(B)),singleton(B)) => in(B,A))))).
