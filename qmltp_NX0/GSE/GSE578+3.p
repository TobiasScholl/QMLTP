...
tff(prove_th19, conjecture, {$box}((! [B:$i]: ({$box}((! [C:$i]: ({$box}((! [D:$i]: ({$box}(({$box}((! [E:$i]: (({$box}(({$box}(member(E,B)) => ({$box}(member(E,C)) & {$box}(member(E,D))))) & {$box}((({$box}(member(E,C)) & {$box}(member(E,D))) => {$box}(member(E,B)))))))) => {$box}(qmltpeq(B,intersection(C,D))))))))))))))).
