...
tff(union_subset, axiom, {$box}((! [B:$i]: ({$box}((! [C:$i]: ({$box}((! [D:$i]: ({$box}((({$box}(subset(B,C)) & {$box}(subset(D,C))) => {$box}(subset(union(B,D),C)))))))))))))).
tff(intersection_is_subset, axiom, {$box}((! [B:$i]: ({$box}((! [C:$i]: ({$box}(subset(intersection(B,C),B))))))))).
tff(subset_difference, axiom, {$box}((! [B:$i]: ({$box}((! [C:$i]: ({$box}((! [D:$i]: ({$box}(({$box}(subset(B,C)) => {$box}(subset(difference(D,C),difference(D,B))))))))))))))).
...
tff(prove_difference_and_intersection_and_union, conjecture, {$box}((! [B:$i]: ({$box}((! [C:$i]: ({$box}((! [D:$i]: ({$box}(qmltpeq(difference(B,intersection(C,D)),union(difference(B,C),difference(B,D)))))))))))))).
